...
void matrixVectorMult(int *matrix, int *vector, int *result, int rows, int cols, int rank, int size) {
...
int main(int argc, char *argv[]) {
    ...
    if (rank == 0) {
        matrixVectorMult(matrix, vector, result, matrix_size, vector_size, rank, size);
        ...
        matrixVectorMult(matrix, vector, result, matrix_size / size, vector_size, rank, size);
